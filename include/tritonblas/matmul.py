...
from .internal.persistent_matmul_a8w8 import persistent_matmul_a8w8
from .internal.streamk_matmul import streamk_matmul
from .internal.streamk_matmul_a8w8 import streamk_matmul_a8w8
...
def matmul_a8w8_lt(
    ...
    if enable_streamk:
        return streamk_matmul_a8w8_lt(a, b, a_scale, b_scale, c, selector)
    else:
        return persistent_matmul_a8w8_lt(a, b, a_scale, b_scale, c, selector)
...
def matmul_a8w8(
    ...
    selector = _make_matmul_selector(M, N, K, a.dtype, b.dtype, c.dtype)
    if enable_streamk:
        return streamk_matmul_a8w8_lt(a, b, a_scale, b_scale, c, selector, sk_grid=sk_grid)
    else:
        return persistent_matmul_a8w8_lt(a, b, a_scale, b_scale, c, selector)
