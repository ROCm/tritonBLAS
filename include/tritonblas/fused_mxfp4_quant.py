...
from tritonblas.kernels.fused_mxfp4_quant import (
    _rmsmorm_op,
    _fused_rms_mxfp4_quant_kernel,
    _fused_flatten_mxfp4_quant,
    _fused_mxfp4_quant_kernel,
    _fused_rms_hadamard_mxfp4_quant_kernel
)
...
def fused_mxfp4_quant(
    ...
    _fused_mxfp4_quant_kernel[grid](
        x1,
        x1_weight,
        x2,
        x2_weight,
...
def fused_rms_hadamard_mxfp4_quant(
    x1: torch.Tensor,
    x1_weight: torch.Tensor,
    x1_epsilon: float,
    x2: Optional[torch.Tensor] = None,
    ...
    grid = (triton.cdiv(M, BLOCK_SIZE_M) * (2 if (x2 is not None) else 1),)
    _fused_rms_hadamard_mxfp4_quant_kernel[grid](
        x1,
        x1_weight,
        x2,
        x2_weight,
